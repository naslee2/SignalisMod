...
public class Eusan_Nation_System {
    ...
    public void generate(SectorAPI sector){
        ...
        vineta_market.addIndustry("eusan_nation_station2");
        ...
        kitezh_market.addIndustry("eusan_nation_station2");
        ...
        PlanetAPI gas_giant1 = system.addPlanet("eusan_nation_gas_giant1", signalisStar, "Jove", "gas_giant", 234f, 400f, 9500f, 4330f);
        ...
        rotfront.getSpec().setTexture(Global.getSettings().getSpriteName("planets","rotfront_planet"));
        rotfront.getSpec().setGlowTexture(Global.getSettings().getSpriteName("hab_glows","rotfront_habglows"));
        rotfront.applySpecChanges();
        ...
        rotfront_market.addIndustry("eusan_nation_station2");
