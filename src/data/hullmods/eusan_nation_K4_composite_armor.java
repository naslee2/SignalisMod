...
public class eusan_nation_K4_composite_armor extends BaseHullMod {
    ...
    public void addPostDescriptionSection(final TooltipMakerAPI tooltip, final ShipAPI.HullSize hullSize, final ShipAPI ship, final float width, final boolean isForModSpec){
        ...
        tooltip.addPara(eusan_nation_k4_composite_armor1, 10.0f, Misc.getHighlightColor(), (int) (100f * ENERGY_damage_reduction) + "%");
        tooltip.addPara(eusan_nation_k4_composite_armor2, 10.0f, Misc.getHighlightColor(), (int) (100f * FRAG_damage_reduction) + "%");
        tooltip.addPara(eusan_nation_k4_composite_armor3, 10.0f, Misc.getHighlightColor(), (int) (100f * HE_damage_reduction) + "%");
        tooltip.addPara(eusan_nation_k4_composite_armor4, 10.0f, Misc.getHighlightColor(), (int) (100f * KINETIC_damage_reduction) + "%");
