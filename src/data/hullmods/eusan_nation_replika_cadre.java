...
public class eusan_nation_replika_cadre extends BaseHullMod {
    ...
    public void addPostDescriptionSection(final TooltipMakerAPI tooltip, final ShipAPI.HullSize hullSize, final ShipAPI ship, final float width, final boolean isForModSpec){
        ...
        tooltip.addPara(eusan_nation_replika_cadre2, 10.0f, Misc.getHighlightColor(), (int) Math.round(REPAIR_BONUS) + "%");
        //tooltip.addPara(eusan_nation_replika_cadre5, 10.0f, Misc.getHighlightColor(), (int) Math.round(OVERLOAD_BONUS) + "%");
        tooltip.addPara("%s", 6.0f, flavor, eusan_nation_replika_cadre3).italicize();
        tooltip.addPara("%s", 6.0f, flavor, eusan_nation_replika_cadre4);
    }
