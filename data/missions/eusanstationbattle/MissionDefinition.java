package data.missions.eusanstationbattle;
...
//		addShip("warthog_wing", 5);
		...
		api.setFleetTagline(FleetSide.ENEMY, "Enemy station");
		...
		// Set up the fleets
		generateFleet(150 + (int)((float) Math.random() * 100), FleetSide.PLAYER, ships, api);
